// eQuo — drill-down into individual employee answers for one question.
// Respects anonymity — anonymous responses show "Anonymous" instead of name.
import React, { useState } from "react";
import { motion, AnimatePresence } from "framer-motion";
import { ChevronDown } from "lucide-react";
import { equoTheme as t, raisedSoft, inset, ratingColor } from "../equoTheme";
                ...
                <div key={r.id} className="p-3 flex items-start gap-3 rounded-xl" style={inset(12)}>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="text-xs font-black" style={{ color: t.text }}>
                      {r.is_anonymous ? "Anonymous" : (r.respondent_name || r.respondent_email)}
                    </div>
                    {r.answer_text ? (
