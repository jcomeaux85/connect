    ...
    <div className="min-h-full relative" style={{ background: pageBg, transition: 'background 0.3s' }}>
      ...
      <div className="flex justify-center py-1.5 border-b" style={{ borderColor: cardBorder }}>
        <div className="flex gap-16 w-4/5 justify-center">
          <Link to="/Cases" className="text-base font-semibold tracking-widest transition-all duration-300" style={{ color: textPrimary, textShadow: '0 0 1px rgba(255,255,255,0.3)' }} onMouseMove={(e) => { const rect = e.currentTarget.getBoundingClientRect(); const distance = Math.hypot(e.clientX - (rect.left + rect.width / 2), e.clientY - (rect.top + rect.height / 2)); const proximity = Math.max(0, 1 - distance / 150); e.currentTarget.style.color = `rgba(255,255,255,${0.4 + proximity * 0.6})`; e.currentTarget.style.textShadow = `0 0 ${proximity * 20}px rgba(255,255,255,${proximity * 1})`; }} onMouseLeave={(e) => { e.currentTarget.style.color = textPrimary; e.currentTarget.style.textShadow = '0 0 1px rgba(255,255,255,0.3)'; }}>CASES</Link>
          <Link to="/Tasks" className="text-base font-semibold tracking-widest transition-all duration-300" style={{ color: textPrimary, textShadow: '0 0 1px rgba(255,255,255,0.3)' }} onMouseMove={(e) => { const rect = e.currentTarget.getBoundingClientRect(); const distance = Math.hypot(e.clientX - (rect.left + rect.width / 2), e.clientY - (rect.top + rect.height / 2)); const proximity = Math.max(0, 1 - distance / 150); e.currentTarget.style.color = `rgba(255,255,255,${0.4 + proximity * 0.6})`; e.currentTarget.style.textShadow = `0 0 ${proximity * 20}px rgba(255,255,255,${proximity * 1})`; }} onMouseLeave={(e) => { e.currentTarget.style.color = textPrimary; e.currentTarget.style.textShadow = '0 0 1px rgba(255,255,255,0.3)'; }}>TASKS</Link>
          <Link to="/Customers" className="text-base font-semibold tracking-widest transition-all duration-300" style={{ color: textPrimary, textShadow: '0 0 1px rgba(255,255,255,0.3)' }} onMouseMove={(e) => { const rect = e.currentTarget.getBoundingClientRect(); const distance = Math.hypot(e.clientX - (rect.left + rect.width / 2), e.clientY - (rect.top + rect.height / 2)); const proximity = Math.max(0, 1 - distance / 150); e.currentTarget.style.color = `rgba(255,255,255,${0.4 + proximity * 0.6})`; e.currentTarget.style.textShadow = `0 0 ${proximity * 20}px rgba(255,255,255,${proximity * 1})`; }} onMouseLeave={(e) => { e.currentTarget.style.color = textPrimary; e.currentTarget.style.textShadow = '0 0 1px rgba(255,255,255,0.3)'; }}>CUSTOMERS</Link>
          <Link to="/Phone" className="text-base font-semibold tracking-widest transition-all duration-300" style={{ color: textPrimary, textShadow: '0 0 1px rgba(255,255,255,0.3)' }} onMouseMove={(e) => { const rect = e.currentTarget.getBoundingClientRect(); const distance = Math.hypot(e.clientX - (rect.left + rect.width / 2), e.clientY - (rect.top + rect.height / 2)); const proximity = Math.max(0, 1 - distance / 150); e.currentTarget.style.color = `rgba(255,255,255,${0.4 + proximity * 0.6})`; e.currentTarget.style.textShadow = `0 0 ${proximity * 20}px rgba(255,255,255,${proximity * 1})`; }} onMouseLeave={(e) => { e.currentTarget.style.color = textPrimary; e.currentTarget.style.textShadow = '0 0 1px rgba(255,255,255,0.3)'; }}>PHONE</Link>
          <Link to="/Messages" className="text-base font-semibold tracking-widest transition-all duration-300" style={{ color: textPrimary, textShadow: '0 0 1px rgba(255,255,255,0.3)' }} onMouseMove={(e) => { const rect = e.currentTarget.getBoundingClientRect(); const distance = Math.hypot(e.clientX - (rect.left + rect.width / 2), e.clientY - (rect.top + rect.height / 2)); const proximity = Math.max(0, 1 - distance / 150); e.currentTarget.style.color = `rgba(255,255,255,${0.4 + proximity * 0.6})`; e.currentTarget.style.textShadow = `0 0 ${proximity * 20}px rgba(255,255,255,${proximity * 1})`; }} onMouseLeave={(e) => { e.currentTarget.style.color = textPrimary; e.currentTarget.style.textShadow = '0 0 1px rgba(255,255,255,0.3)'; }}>MESSAGES</Link>
          <Link to="/Timeline" className="text-base font-semibold tracking-widest transition-all duration-300" style={{ color: textPrimary, textShadow: '0 0 1px rgba(255,255,255,0.3)' }} onMouseMove={(e) => { const rect = e.currentTarget.getBoundingClientRect(); const distance = Math.hypot(e.clientX - (rect.left + rect.width / 2), e.clientY - (rect.top + rect.height / 2)); const proximity = Math.max(0, 1 - distance / 150); e.currentTarget.style.color = `rgba(255,255,255,${0.4 + proximity * 0.6})`; e.currentTarget.style.textShadow = `0 0 ${proximity * 20}px rgba(255,255,255,${proximity * 1})`; }} onMouseLeave={(e) => { e.currentTarget.style.color = textPrimary; e.currentTarget.style.textShadow = '0 0 1px rgba(255,255,255,0.3)'; }}>TIMELINE</Link>
        </div>
      </div>
