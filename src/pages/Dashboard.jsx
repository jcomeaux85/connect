    ...
    <div className="min-h-full relative" style={{ background: pageBg, transition: 'background 0.3s' }}>
      ...
      <div className="flex justify-center py-1.5 border-b" style={{ borderColor: cardBorder }}>
        <div className="flex gap-16 w-4/5 justify-center">
          <Link to="/Cases" className="text-base font-semibold tracking-widest transition-all duration-300" style={{ color: textPrimary, textShadow: '0 0 1px rgba(255,255,255,0.3)' }} onMouseMove={(e) => { const rect = e.currentTarget.getBoundingClientRect(); const x = e.clientX - rect.left; e.currentTarget.style.color = `rgba(255,255,255,${Math.min(1, x / rect.width + 0.5)})`; e.currentTarget.style.textShadow = `0 0 ${Math.min(12, x / rect.width * 12)}px rgba(255,255,255,${Math.min(0.8, x / rect.width + 0.2)})`; }} onMouseLeave={(e) => { e.currentTarget.style.color = textPrimary; e.currentTarget.style.textShadow = '0 0 1px rgba(255,255,255,0.3)'; }}>CASES</Link>
          <Link to="/Tasks" className="text-base font-semibold tracking-widest transition-all duration-300" style={{ color: textPrimary, textShadow: '0 0 1px rgba(255,255,255,0.3)' }} onMouseMove={(e) => { const rect = e.currentTarget.getBoundingClientRect(); const x = e.clientX - rect.left; e.currentTarget.style.color = `rgba(255,255,255,${Math.min(1, x / rect.width + 0.5)})`; e.currentTarget.style.textShadow = `0 0 ${Math.min(12, x / rect.width * 12)}px rgba(255,255,255,${Math.min(0.8, x / rect.width + 0.2)})`; }} onMouseLeave={(e) => { e.currentTarget.style.color = textPrimary; e.currentTarget.style.textShadow = '0 0 1px rgba(255,255,255,0.3)'; }}>TASKS</Link>
          <Link to="/Customers" className="text-base font-semibold tracking-widest transition-all duration-300" style={{ color: textPrimary, textShadow: '0 0 1px rgba(255,255,255,0.3)' }} onMouseMove={(e) => { const rect = e.currentTarget.getBoundingClientRect(); const x = e.clientX - rect.left; e.currentTarget.style.color = `rgba(255,255,255,${Math.min(1, x / rect.width + 0.5)})`; e.currentTarget.style.textShadow = `0 0 ${Math.min(12, x / rect.width * 12)}px rgba(255,255,255,${Math.min(0.8, x / rect.width + 0.2)})`; }} onMouseLeave={(e) => { e.currentTarget.style.color = textPrimary; e.currentTarget.style.textShadow = '0 0 1px rgba(255,255,255,0.3)'; }}>CUSTOMERS</Link>
          <Link to="/Phone" className="text-base font-semibold tracking-widest transition-all duration-300" style={{ color: textPrimary, textShadow: '0 0 1px rgba(255,255,255,0.3)' }} onMouseMove={(e) => { const rect = e.currentTarget.getBoundingClientRect(); const x = e.clientX - rect.left; e.currentTarget.style.color = `rgba(255,255,255,${Math.min(1, x / rect.width + 0.5)})`; e.currentTarget.style.textShadow = `0 0 ${Math.min(12, x / rect.width * 12)}px rgba(255,255,255,${Math.min(0.8, x / rect.width + 0.2)})`; }} onMouseLeave={(e) => { e.currentTarget.style.color = textPrimary; e.currentTarget.style.textShadow = '0 0 1px rgba(255,255,255,0.3)'; }}>PHONE</Link>
          <Link to="/Messages" className="text-base font-semibold tracking-widest transition-all duration-300" style={{ color: textPrimary, textShadow: '0 0 1px rgba(255,255,255,0.3)' }} onMouseMove={(e) => { const rect = e.currentTarget.getBoundingClientRect(); const x = e.clientX - rect.left; e.currentTarget.style.color = `rgba(255,255,255,${Math.min(1, x / rect.width + 0.5)})`; e.currentTarget.style.textShadow = `0 0 ${Math.min(12, x / rect.width * 12)}px rgba(255,255,255,${Math.min(0.8, x / rect.width + 0.2)})`; }} onMouseLeave={(e) => { e.currentTarget.style.color = textPrimary; e.currentTarget.style.textShadow = '0 0 1px rgba(255,255,255,0.3)'; }}>MESSAGES</Link>
          <Link to="/Timeline" className="text-base font-semibold tracking-widest transition-all duration-300" style={{ color: textPrimary, textShadow: '0 0 1px rgba(255,255,255,0.3)' }} onMouseMove={(e) => { const rect = e.currentTarget.getBoundingClientRect(); const x = e.clientX - rect.left; e.currentTarget.style.color = `rgba(255,255,255,${Math.min(1, x / rect.width + 0.5)})`; e.currentTarget.style.textShadow = `0 0 ${Math.min(12, x / rect.width * 12)}px rgba(255,255,255,${Math.min(0.8, x / rect.width + 0.2)})`; }} onMouseLeave={(e) => { e.currentTarget.style.color = textPrimary; e.currentTarget.style.textShadow = '0 0 1px rgba(255,255,255,0.3)'; }}>TIMELINE</Link>
        </div>
      </div>
