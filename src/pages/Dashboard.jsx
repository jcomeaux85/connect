    ...
    <div className="min-h-full relative" style={{ background: pageBg, transition: 'background 0.3s' }}>
      ...
      <div className="flex justify-center py-1.5 border-b" style={{ borderColor: cardBorder }}>
        <div className="flex gap-16 w-4/5 justify-center">
          <Link to="/Cases" className="text-base font-semibold tracking-widest transition-all duration-300" style={{ color: textPrimary, backdropFilter: 'blur(10px)', boxShadow: 'inset 0 1px 1px rgba(255,255,255,0.2)' }} onMouseMove={(e) => { const rect = e.currentTarget.getBoundingClientRect(); const x = e.clientX - rect.left; e.currentTarget.style.boxShadow = `inset 0 1px 1px rgba(255,255,255,0.2), 0 0 20px rgba(255,255,255,${Math.min(0.6, x / rect.width + 0.1)})`; e.currentTarget.style.color = `rgba(255,255,255,${Math.min(1, x / rect.width + 0.5)})`; }} onMouseLeave={(e) => { e.currentTarget.style.boxShadow = 'inset 0 1px 1px rgba(255,255,255,0.2)'; e.currentTarget.style.color = textPrimary; }}>CASES</Link>
          <Link to="/Tasks" className="text-base font-semibold tracking-widest transition-all duration-300" style={{ color: textPrimary, backdropFilter: 'blur(10px)', boxShadow: 'inset 0 1px 1px rgba(255,255,255,0.2)' }} onMouseMove={(e) => { const rect = e.currentTarget.getBoundingClientRect(); const x = e.clientX - rect.left; e.currentTarget.style.boxShadow = `inset 0 1px 1px rgba(255,255,255,0.2), 0 0 20px rgba(255,255,255,${Math.min(0.6, x / rect.width + 0.1)})`; e.currentTarget.style.color = `rgba(255,255,255,${Math.min(1, x / rect.width + 0.5)})`; }} onMouseLeave={(e) => { e.currentTarget.style.boxShadow = 'inset 0 1px 1px rgba(255,255,255,0.2)'; e.currentTarget.style.color = textPrimary; }}>TASKS</Link>
          <Link to="/Customers" className="text-base font-semibold tracking-widest transition-all duration-300" style={{ color: textPrimary, backdropFilter: 'blur(10px)', boxShadow: 'inset 0 1px 1px rgba(255,255,255,0.2)' }} onMouseMove={(e) => { const rect = e.currentTarget.getBoundingClientRect(); const x = e.clientX - rect.left; e.currentTarget.style.boxShadow = `inset 0 1px 1px rgba(255,255,255,0.2), 0 0 20px rgba(255,255,255,${Math.min(0.6, x / rect.width + 0.1)})`; e.currentTarget.style.color = `rgba(255,255,255,${Math.min(1, x / rect.width + 0.5)})`; }} onMouseLeave={(e) => { e.currentTarget.style.boxShadow = 'inset 0 1px 1px rgba(255,255,255,0.2)'; e.currentTarget.style.color = textPrimary; }}>CUSTOMERS</Link>
          <Link to="/Phone" className="text-base font-semibold tracking-widest transition-all duration-300" style={{ color: textPrimary, backdropFilter: 'blur(10px)', boxShadow: 'inset 0 1px 1px rgba(255,255,255,0.2)' }} onMouseMove={(e) => { const rect = e.currentTarget.getBoundingClientRect(); const x = e.clientX - rect.left; e.currentTarget.style.boxShadow = `inset 0 1px 1px rgba(255,255,255,0.2), 0 0 20px rgba(255,255,255,${Math.min(0.6, x / rect.width + 0.1)})`; e.currentTarget.style.color = `rgba(255,255,255,${Math.min(1, x / rect.width + 0.5)})`; }} onMouseLeave={(e) => { e.currentTarget.style.boxShadow = 'inset 0 1px 1px rgba(255,255,255,0.2)'; e.currentTarget.style.color = textPrimary; }}>PHONE</Link>
          <Link to="/Messages" className="text-base font-semibold tracking-widest transition-all duration-300" style={{ color: textPrimary, backdropFilter: 'blur(10px)', boxShadow: 'inset 0 1px 1px rgba(255,255,255,0.2)' }} onMouseMove={(e) => { const rect = e.currentTarget.getBoundingClientRect(); const x = e.clientX - rect.left; e.currentTarget.style.boxShadow = `inset 0 1px 1px rgba(255,255,255,0.2), 0 0 20px rgba(255,255,255,${Math.min(0.6, x / rect.width + 0.1)})`; e.currentTarget.style.color = `rgba(255,255,255,${Math.min(1, x / rect.width + 0.5)})`; }} onMouseLeave={(e) => { e.currentTarget.style.boxShadow = 'inset 0 1px 1px rgba(255,255,255,0.2)'; e.currentTarget.style.color = textPrimary; }}>MESSAGES</Link>
          <Link to="/Timeline" className="text-base font-semibold tracking-widest transition-all duration-300" style={{ color: textPrimary, backdropFilter: 'blur(10px)', boxShadow: 'inset 0 1px 1px rgba(255,255,255,0.2)' }} onMouseMove={(e) => { const rect = e.currentTarget.getBoundingClientRect(); const x = e.clientX - rect.left; e.currentTarget.style.boxShadow = `inset 0 1px 1px rgba(255,255,255,0.2), 0 0 20px rgba(255,255,255,${Math.min(0.6, x / rect.width + 0.1)})`; e.currentTarget.style.color = `rgba(255,255,255,${Math.min(1, x / rect.width + 0.5)})`; }} onMouseLeave={(e) => { e.currentTarget.style.boxShadow = 'inset 0 1px 1px rgba(255,255,255,0.2)'; e.currentTarget.style.color = textPrimary; }}>TIMELINE</Link>
        </div>
      </div>
