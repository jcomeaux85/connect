...
const DEMO_CALLS = {
  Ryan: [
    ...
    { time: '09:08', direction: 'inbound',  duration: 4980 },  // 1h 23m
    ...
    { time: '13:14', direction: 'outbound', duration: 5520 },  // 1h 32m
  ...
  Vanessa: [
    ...
    { time: '09:43', direction: 'outbound', duration: 5160 },  // 1h 26m
    ...
    { time: '14:49', direction: 'inbound',  duration: 4740 },  // 1h 19m
  ...
  Chris: [
    ...
    { time: '09:26', direction: 'inbound',  duration: 5700 },  // 1h 35m
    ...
    { time: '14:55', direction: 'outbound', duration: 4860 },  // 1h 21m
  ...
  Jarrad: [
    ...
    { time: '10:04', direction: 'outbound', duration: 5400 },  // 1h 30m
    ...
    { time: '14:37', direction: 'inbound',  duration: 4980 },  // 1h 23m
