            ...
            <div className="flex items-end gap-1 flex-shrink-0">
              {navigationItems.map((item) => {
                ...
                return (
                  <Link
                    key={item.title}
                    to={item.url} className="pb-2 px-4 text-lg font-thin text-center no-underline lowercase rounded-[0px_0px_4px_4px] flex items-end justify-center transition-all"
