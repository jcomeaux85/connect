  ...
  return (
    <div className="flex h-screen overflow-hidden" style={{ ...getBackgroundStyle(), transition: `background ${getTransitionDuration(300)}` }}>
      ...
      <div className="flex flex-col flex-1 overflow-hidden">
        ...
        style={{ background: '#ffffff', borderBottom: `1px solid ${colors.border}`, overflow: 'visible' }}>
          
          <div className="bg-[#000000] text-[hsl(var(--chart-4))] my-1 px-3 opacity-100 rounded flex items-stretch justify-between relative" style={{ height: '52px', gap: '8px', overflow: 'visible' }}>
